  ...
  <div class="main-container full-width">
    <div class="container">
      <div class="breadcrumbs">
        ...
        <span class="separator">/</span><span> Giỏ hàng</span>
      </div>
    </div>
        ...
        >
          <div class="entry-content">
            <div v-if="getterListItemInCart.length" class="woocommerce">
              <form
                action="http://demo.roadthemes.com/james/cart/"
                method="post"
              >
                ...
                <div
                  class="d-flex"
                  style="display: flex;align-items: center;justify-content: flex-end;margin-bottom: 50px"
                >
                  <h3 style="margin: 0; padding-right: 20px">Tổng tiền :</h3>
            ...
            <h3
              ...
              v-if="!getterListItemInCart.length"
            >
