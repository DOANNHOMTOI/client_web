          ...
          <div class="row">
			...
			<span class="link_text">
				Shop
                            ...
                            <ul class="mega_dropdown">
                              <li id="menu-item-3789"
                                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3789 default_dropdown default_style drop_to_right submenu_default_width columns1"
					...
					Shop Layouts
                                ...
                                <ul class="mega_dropdown">
                                  <li id="menu-item-3788"
                                      class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3788 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/shop/?layout=fullwidth"
                                       class="item_link  disable_icon" tabindex="6">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Full Width
                                  ...
                                  <li id="menu-item-3790"
                                      class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3790 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a
                                      href="http://demo.roadthemes.com/james/shop/?layout=sidebar&amp;sidebar=left"
                                      class="item_link  disable_icon" tabindex="7">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Sidebar Left
                                  ...
                                  <li id="menu-item-3791"
                                      class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3791 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a
                                      href="http://demo.roadthemes.com/james/shop/?layout=sidebar&amp;sidebar=right"
                                      class="item_link  disable_icon" tabindex="8">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Sidebar Right
                                  ...
                                  <li id="menu-item-3792"
                                      class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3792 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/shop/?view=list-view"
                                       class="item_link  disable_icon" tabindex="9">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						List View
                              ...
                              <li id="menu-item-3786"
                                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3786 default_dropdown default_style drop_to_right submenu_default_width columns1"
                                  style="width:33.333333333333%;">
				...
				<span class="link_text">
					Shop Pages
                                ...
                                <ul class="mega_dropdown">
                                  <li id="menu-item-3847"
                                      class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-3847 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/product-category/health-beauty/"
                                       class="item_link  disable_icon" tabindex="11">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Category
                                  ...
                                  <li id="menu-item-4019"
                                      class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4019 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/my-account/"
					...
					<span class="link_text">
						My Account
                                  ...
                                  <li id="menu-item-4097"
                                      class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4097 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/wishlist/"
                                       class="item_link  disable_icon" tabindex="13">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Wishlist
                                  ...
                                  <li id="menu-item-4020"
                                      class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4020 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/cart/"
					...
					<span class="link_text">
						Shopping Cart
                                  ...
                                  <li id="menu-item-4018"
                                      class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4018 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/checkout/"
                                       class="item_link  disable_icon" tabindex="15">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Checkout
                              ...
                              <li id="menu-item-3787"
                                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3787 default_dropdown default_style drop_to_right submenu_default_width columns1"
                                  style="width:33.333333333333%;">
					...
					Product Types
                                ...
                                <ul class="mega_dropdown">
                                  <li id="menu-item-4033"
                                      class="menu-item menu-item-type-post_type menu-item-object-product menu-item-4033 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/shop/footwear/turpis-velit-aliquet/"
                                       class="item_link  disable_icon" tabindex="17">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Simple Product
                                  ...
                                  <li id="menu-item-4034"
                                      class="menu-item menu-item-type-post_type menu-item-object-product menu-item-4034 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/shop/shoes/aliquam-lobortis/"
                                       class="item_link  disable_icon" tabindex="18">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Variable Product
                                  ...
                                  <li id="menu-item-4038"
                                      class="menu-item menu-item-type-post_type menu-item-object-product menu-item-4038 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a
                                      href="http://demo.roadthemes.com/james/shop/t-oys-gifts/convallis-quam-sit/"
                                      class="item_link  disable_icon" tabindex="19">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Grouped Product
                                  ...
                                  <li id="menu-item-4036"
                                      class="menu-item menu-item-type-post_type menu-item-object-product menu-item-4036 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a
                                      href="http://demo.roadthemes.com/james/shop/t-oys-gifts/cheap-belstaff-bags/"
                                      class="item_link  disable_icon" tabindex="20">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						External Product
                                  ...
                                  <li id="menu-item-4035"
                                      class="menu-item menu-item-type-post_type menu-item-object-product menu-item-4035 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a
                                      href="http://demo.roadthemes.com/james/shop/t-oys-gifts/pellentesque-posuere-2/"
                                      class="item_link  disable_icon" tabindex="21">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Downloadable
                                  ...
                                  <li id="menu-item-4037"
                                      class="menu-item menu-item-type-post_type menu-item-object-product menu-item-4037 default_dropdown default_style drop_to_right submenu_default_width columns1">
                                    <a href="http://demo.roadthemes.com/james/shop/t-oys-gifts/nulla-sed-libero/"
                                       class="item_link  disable_icon" tabindex="22">
                                      <i class=""></i>
                                      <span class="link_content">
					<span class="link_text">
						Virtual Product
