              ...
              <div class="u-column1 col-1" style="float: none;margin: 100px auto;">
                ...
                <form class="woocomerce-form woocommerce-form-login login" method="post">
                  ...
                  <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    ...
                    <input v-model="phone" type="number" maxlength=10
                  ...
                  <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    ...
                    <input v-model="password" class="woocommerce-Input woocommerce-Input--text input-text"
                      type="password" name="password" id="password">
                  </p>


                  <p class="form-row" style="margin-top: 20px">
                    <input @click="submitForm" type="button" class="woocommerce-Button button" name="login"
                      value="Xác nhận">
                  </p>
